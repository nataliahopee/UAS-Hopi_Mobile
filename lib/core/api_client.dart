...
class ApiClient {
  ...
  // getBookingData(String accesstoken) {}

  // delBooking(String accesstoken, int id) {}

  // updateBooking(String accesstoken, Map<String, dynamic> bookingData, int id) {}

  // addBooking(String accesstoken, Map<String, dynamic> bookingData) {}
}

Future<List<Booking>> getBookingData(String accessToken) async {
  try {
    final response = await Booking.client.get(
...
Future<dynamic> addBooking(
    String accessToken, Map<String, dynamic>? data) async {
  try {
    final response = await Booking.client.post(
...
Future<dynamic> delBooking(String accessToken, dynamic id) async {
  try {
    final response = await Booking.client.delete(
